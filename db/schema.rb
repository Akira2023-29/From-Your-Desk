...
ActiveRecord::Schema[7.0].define(version: 20_240_123_120_751) do
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.index %w[user_id diagnosis_id], name: 'index_favorites_on_user_id_and_diagnosis_id', unique: true
